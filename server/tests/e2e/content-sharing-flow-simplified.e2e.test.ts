/**
 * E2E Test: Content Upload and Sharing Flow (Simplified)
 *
 ...
 *
 * This test validates content sharing:
 * Upload File → Share in Message → Receive → React
 */
...
describe('E2E: Content Upload and Sharing Flow', () => {
  let tc: TestContext
  let alice: TestClaw
  let bob: TestClaw
